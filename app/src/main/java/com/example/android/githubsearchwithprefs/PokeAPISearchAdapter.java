...
public class PokeAPISearchAdapter extends RecyclerView.Adapter<PokeAPISearchAdapter.SearchResultViewHolder> {
    private ArrayList<GitHubUtils.SearchResult> mSearchResultsList;
    OnSearchItemClickListener mSeachItemClickListener;

    PokeAPISearchAdapter(OnSearchItemClickListener searchItemClickListener) {
